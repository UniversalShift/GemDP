...
[Gem](https://github.com/UniversalShift/GemDP) allows you to use powerful python libraries or modules in datapack creating (like math) which makes it much easier.
